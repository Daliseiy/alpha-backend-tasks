...
import { CreateCandidateDocumentAndSummaryTables1710000001000 } from '../migrations/1710000001000-CreateCandidateDocumentAndSummaryTables';
...
export const getTypeOrmOptions = (
  ...
  migrations: [
    ...
    CreateCandidateDocumentAndSummaryTables1710000001000,
  ],
